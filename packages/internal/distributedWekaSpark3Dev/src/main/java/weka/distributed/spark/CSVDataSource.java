...
public class CSVDataSource extends FileDataSource implements
  ...
  public boolean runJobWithContext(JavaSparkContext sparkContext)
    ...
    // TODO - don't know if Spark 3 has/needs different charsets for CSV
    Dataset<Row> df =
      sparkSession.read().format("csv").option("inferSchema", m_inferSchema ? "true" : "false")
        ...
        .option("nullValue", m_missingValue)
